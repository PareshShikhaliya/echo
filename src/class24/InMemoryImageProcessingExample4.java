...
public class InMemoryImageProcessingExample4 {

    public static void main(String[] args) {
        try {
            // Load the image from a file or any other source
            BufferedImage originalImage = ImageIO.read(new File("C:\\Users\\pares\\IdeaProjects\\Echo\\src\\class24\\mesi.jpg"));
    ...
    public static void processInMemoryImage(byte[] imageBytes) throws IOException {
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(imageBytes)) {
            ...
            ImageIO.write(processedImage, "jpg", new File("C:\\Users\\pares\\IdeaProjects\\Echo\\src\\class24\\mesiBW.jpg"));
        }
    }
